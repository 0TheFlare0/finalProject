...
>         We added more sprites into the image folder and converted them into PNG images. We also found out and
...
>         We were successful in making the ship shoot a limited ammount of bullets as well as started to figure
...
>         The boss now blits on screen as well as now moves up and down on screen by itself. The only issue is that
